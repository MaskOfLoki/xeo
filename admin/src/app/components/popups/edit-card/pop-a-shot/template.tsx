...
export function template(this: EditPopAShot, { onchange }) {
  return (
    <div class={styles.controlWrapper}>
      <div class={styles.timersColumn}>
        ...
        <div class={styles.groupTimerInput}>
          <div class={styles.timerLabel}>Game Timer</div>
          <div class={styles.groupTimer}>
            <input
              class='gc-input'
              type='number'
      ...
      <div class={styles.row}>
        <div class={styles.color}>
          <ColorPicker
            label='Primary'
            color={this.card.colors?.primary ?? '#DAFAFF'}
            gradient={true}
            onchange={(color) => {
        ...
        <div class={styles.imageUpload}>
          <FileUpload
            title='Game Icon'
            value={this.card.images?.icon}
            onchange={(value) => {
              this.card.images.icon = value;
              onchange();
            }}
          />
        </div>
      ...
      <div class={styles.row}>
        ...
        <div class={styles.imageUpload}>
          <FileUpload
            title='Team Logo'
            value={this.card.images?.teamLogo}
            onchange={(value) => {
              this.card.images.teamLogo = value;
              onchange();
            }}
          />
        </div>
