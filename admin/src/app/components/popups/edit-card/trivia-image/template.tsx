import { EditTriviaImage } from './index';
...
export function template(this: EditTriviaImage) {
    ...
    <div class={styles.controlWrapper}>
          ...
          <div class={styles.answer}>
            ...
            <div class={styles.answerImageWrapper}>
              <FileUpload
                class={styles.image}
                value={answer.url}
                onchange={this.answerImageChangeHandler.bind(this, answer)}
              />
            </div>
            <div class={styles.correctAnswerWrapper}>
              <button
                class={answer.correct ? 'selected' : 'outline'}
      ...
      <div class={styles.row}>
        ...
        <div class={styles.column}>
          ...
          <div class={styles.color}>
            <ColorPicker
              color={this.card.colors?.backgroundQuestion ?? '#0B224A'}
              gradient={true}
