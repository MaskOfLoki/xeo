...
export function template(this: EditHatShuffle, { onchange }) {
  return (
        ...
        <div class={styles.groupTimerInput}>
          ...
          <div class={styles.groupTimer}>
            <input
              ...
              max='99'
              min='0'
              value={this.revealMinutes.toString().padStart(2, '0')}
              oninput={(e) => {
                const value = parseInt(e.target.value);
                if (value || value === 0) {
                  this.revealMinutes = value;
                }
              }}
            />
            <span class={styles.semiLabel}>:</span>
            <input
              ...
              max='59'
              min='0'
              value={this.revealSeconds.toString().padStart(2, '0')}
              oninput={(e) => {
                const value = parseInt(e.target.value);
                if (value || value === 0) {
                  this.revealSeconds = value;
                }
              }}
            />
          </div>
