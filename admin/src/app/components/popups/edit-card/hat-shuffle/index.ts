...
import { IntegratedGame, IHatShuffleCard } from '../../../../../../../common/common';

const SPLASH_SCREEN_TIMER_DEFAULT = 60000;
const GAME_START_TIMER_DEFAULT = 10000;
const REVEAL_TIMER_DEFAULT = 20000;

export class EditHatShuffle extends BaseEdit {
  ...
  public get card(): IHatShuffleCard {
    return this._card as IHatShuffleCard;
  }
  ...
  public set revealSeconds(value: number) {
    if (value > 59) {
      return;
    }

    this.card.timers.reveal = this.revealMinutes * 60000 + value * 1000;
  }

  public get revealSeconds(): number {
    return Math.floor((this.card.timers.reveal - this.revealMinutes * 60000) * 0.001);
  }

  public set revealMinutes(value: number) {
    if (value > 99) {
      return;
    }

    this.card.timers.reveal = value * 60000 + this.revealSeconds * 1000;
  }

  public get revealMinutes(): number {
    return Math.floor(this.card.timers.reveal / 60000);
  }
}
