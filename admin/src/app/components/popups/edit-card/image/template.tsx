...
export function template(this: EditImage, { card }: IBaseEditAttrs) {
  return (
    <div class={styles.browserCard}>
      ...
      <div class={styles.rightCol}>{this.rightPanel && m(this.rightPanel, { card, onChange: this._onchange })}</div>
    </div>
  );
}
